package cn.com.pansky.share.utils;
...
public class UploadServlet extends HttpServlet {
    ...
    public static final String UPLOAD_DIR = "d:/test/share/upload";
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if (info.checkIfUploadFinished()) { //Check if all chunks uploaded, and change filename
            ...
            try {
    			Thread.sleep(5000);
    			File temp = new File(info.resumableFilePath);
    			if(temp.exists()){
    				temp.delete();
    			}
    ...
    private ResumableInfo getResumableInfo(HttpServletRequest request) throws ServletException {
        ...
        resumableFilePath = base_dir+"/"+resumableFilename+".temp";
